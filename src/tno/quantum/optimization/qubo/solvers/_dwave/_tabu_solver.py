"""This module contains the ``TabuSolver`` class."""
...
class TabuSolver(Solver[DimodSampleSetResult]):
    """D-Wave tabu solver.

    The :py:class:`TabuSolver` class solves QUBOs using the D-Wave implementation
    (:py:class:`~dwave.samplers.TabuSampler`) of tabu.

    Example:
        >>> from tno.quantum.optimization.qubo.components import QUBO
        >>> from tno.quantum.optimization.qubo.solvers import TabuSolver
        >>>
        ...
        **sample_kwargs: Any,
        ...
        Args:
            ...
            sample_kwargs: Additional keyword arguments that can be used for the
                ...
                :py:meth:`~dwave.samplers.TabuSampler.sample` for possible
        ...
        """
        self.sampler = get_singleton(TabuSampler)
